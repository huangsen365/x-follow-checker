...
const translations = {
  en: {
    ...
    usernameRequiredDesc: 'Please enter your X username above to start the check.',
...
{mentions}`,
  ...
  zh: {
    ...
    usernameRequiredDesc: '请在上方输入您的 X 用户名后再开始检测。',
...
{mentions}`,
  ...
  'zh-TW': {
    ...
    usernameRequiredDesc: '請在上方輸入您的 X 用戶名後再開始檢測。',
