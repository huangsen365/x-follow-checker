...
{mentions}`,
    ...
    browseVerified: 'Browse Verified',
    verifiedFollowers: 'Verified Followers',
    loadVerified: 'Load Verified Followers',
    loadCachedVerified: 'Load Cached Verified Followers',
    refetchVerified: 'Re-fetch Verified Followers',
    verifiedFollowersLoaded: 'Verified Followers',
    noVerifiedYet: 'No verified followers loaded yet',
    enterUsernameToStart: 'Enter a username above and click "Load Verified Followers"',
    sidePanelNote: 'Use the profile browse buttons to open follower homepages in the current tab',
    prevProfile: 'Prev Profile',
    nextProfile: 'Next Profile',
    noProfileSelected: 'No profile selected',
    browsingProfile: 'Browsing @{username} ({index}/{total})',
    previous: 'Previous',
    next: 'Next',
    page: 'Page'
  },
...
{mentions}`,
    ...
    browseVerified: '浏览认证用户',
    verifiedFollowers: '认证关注者',
    loadVerified: '加载认证关注者',
    loadCachedVerified: '加载缓存认证关注者',
    refetchVerified: '重新获取认证关注者',
    verifiedFollowersLoaded: '认证关注者',
    noVerifiedYet: '暂未加载认证关注者',
    enterUsernameToStart: '请在上方输入用户名并点击"加载认证关注者"',
    sidePanelNote: '使用主页浏览按钮可在当前标签页打开关注者主页',
    prevProfile: '上一位主页',
    nextProfile: '下一位主页',
    noProfileSelected: '尚未选择主页',
    browsingProfile: '正在浏览 @{username}（{index}/{total}）',
    previous: '上一页',
    next: '下一页',
    page: '第{0}页'
  },
...
{mentions}`,
    ...
    browseVerified: '瀏覽認證用戶',
    verifiedFollowers: '認證追蹤者',
    loadVerified: '載入認證追蹤者',
    loadCachedVerified: '載入快取認證追蹤者',
    refetchVerified: '重新取得認證追蹤者',
    verifiedFollowersLoaded: '認證追蹤者',
    noVerifiedYet: '暫未載入認證追蹤者',
    enterUsernameToStart: '請在上方輸入用戶名並點擊「載入認證追蹤者」',
    sidePanelNote: '使用主頁瀏覽按鈕可在目前分頁開啟追蹤者主頁',
    prevProfile: '上一位主頁',
    nextProfile: '下一位主頁',
    noProfileSelected: '尚未選擇主頁',
    browsingProfile: '正在瀏覽 @{username}（{index}/{total}）',
    previous: '上一頁',
    next: '下一頁',
    page: '第{0}頁'
  }
